...
class InceptionNet(nn.Module):
    ...
    def forward(self, input):
        ...
        pred_3b = self.st_3b(fusion_3b) #,sub_feature_3b
        pred_4d = self.st_4d(fusion_4d) #,sub_feature_4d
        pred_5b = self.st_5b(fusion_5b) #,sub_feature_5b

        return pred_3b, pred_4d, pred_5b, main_pred  #,sub_feature_3b,sub_feature_4d,sub_feature_5b
